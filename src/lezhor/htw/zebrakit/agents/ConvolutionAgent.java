...
public class ConvolutionAgent {
    ...
    public static void main(String[] args) {
        ...
        NetworkClient client = new NetworkClient(host, name, "yeaaaah");
        ...
        while (client.isAlive()) {
            ...
            for (int bot = 0; bot < 3; bot++) {
                ...
                if (botTargets[bot] == null) {
                    ...
                    needsTarget = true;
                } else if (System.currentTimeMillis() - targetStartTimes[bot] > 4000) {
                    needsTarget = true; // Refresh target after 4 seconds
